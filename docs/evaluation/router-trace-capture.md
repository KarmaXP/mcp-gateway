...
Optional procedure for **new** calibration runs when you want Tempo trace figures alongside Prometheus numbers. Canonical lab sessions are in [calibration-results.md](calibration-results.md): multibackend assay (2026-05-30) marks Tempo host decomposition **Not measured**; LangGraph agent assay (2026-06-08) records one representative trace as **Measured** via Grafana datasource proxy.
