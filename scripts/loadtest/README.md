...
### JWT loadtest (LangGraph agent assay)

The multibackend assay (2026-05-30) uses repeated `smoke_e2e.sh` + Prometheus means instead of loadtest (see [integration-checklist.md](../../docs/evaluation/integration-checklist.md)). The LangGraph agent assay adds JWT loadtest below.
